...
- [ ] **Phase 1: Compilation and Simulation Engine** - Backend pipeline: Mock HAL stubs, server-side compilation, execution runner, state manager, and WebSocket broadcasting
